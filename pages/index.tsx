                ...
                <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        ...
                        <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                            ...
                            Cras tempus sit amet diam eget commodo.
                        </p>
                        <a
                            href="/register"
                    ...
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                ...
                                adipiscing elit. Phasellus eu finibus nulla.
                                Donec sagittis ornare sapien, sed vulputate
                                augue ultricies eget. Cras tempus sit amet diam
                                eget commodo. Donec ullamcorper elit a felis
                                sodales, nec condimentum lectus venenatis.
                                Aenean scelerisque vestibulum ante, in
                                pellentesque felis posuere et.
                            </p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-blue-900">
