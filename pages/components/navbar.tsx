        ...
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-slate-700 sticky top-0 z-50">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                ...
                <div className="flex md:order-2">
                    ...
                    <button type="button" className="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center md:mr-0 hover:text-slate-400">
                        Sign Up
                    </button>
                    <button
