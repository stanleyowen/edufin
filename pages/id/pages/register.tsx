        ...
        if (data.password !== data.confirmPassword)
            ...
            try {
                ...
                if (
                    ...
                    setError("Kredensial tidak valid.  Silahkan ulangi kembali.");
                else if (e.code === "user-token-expired")
                    setError("Sesi anda telah berakhir.  Silahkan masuk kembali.");
                else if (e.code === "auth/email-already-in-use")
                    setError("Email telah digunakan. Silahkan ulangi kembali.");
